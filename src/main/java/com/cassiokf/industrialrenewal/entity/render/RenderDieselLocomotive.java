...
public class RenderDieselLocomotive<T extends EntityDieselLocomotive> extends RenderBase<EntityDieselLocomotive> {

    public static final ResourceLocation TEXTURES = new ResourceLocation(IndustrialRenewal.MODID + ":textures/entities/diesellocomotive.png");

    public RenderDieselLocomotive(EntityRendererProvider.Context context) {
        super(context, ModelDieselLocomotive.LAYER_LOCATION);
    }

    @Override
    public ResourceLocation getTextureLocation(EntityDieselLocomotive p_114482_) {
        return TEXTURES;
    }

    @Override
    public void render(EntityDieselLocomotive entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLightIn) {
...
//
//                Direction entityDir = TrainUtil.getTravelDirection(entity.getDeltaMovement());
//                if (entityDir == Direction.NORTH || entityDir == Direction.WEST) {
//                    vector3d3 = vector3d3.multiply(new Vec3(-1, 0, -1));
//                }
