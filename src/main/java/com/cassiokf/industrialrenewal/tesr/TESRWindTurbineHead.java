...
//            Utils.debug("r", rotation);
            render3dItem(stack, lighting(blockEntity), combinedOverlay, buffer, facing, blockEntity.getLevel(), xPos, y + 0.5f, zPos, blade, 12, false, true, rotation, 0, 1, 0, true, false);
        }
    }
}
