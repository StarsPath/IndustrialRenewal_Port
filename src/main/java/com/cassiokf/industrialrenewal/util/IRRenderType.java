...
public class IRRenderType extends RenderType {
    ...
    public static final RenderType WIRE_RENDER_TYPE = create("WireRenderType",
            DefaultVertexFormat.POSITION_COLOR_TEX, VertexFormat.Mode.QUADS, 256, false, false,
            RenderType.CompositeState.builder().setTextureState(new TextureStateShard(wireResourceLocation, false, false))
